    ...
    public class CantineServiceBDD : ICantineService
    {
        ...
        public async Task<IEnumerable<IArticle>> ListeArticlesAsync(IArticleSearch search)
        {
            ...
            if (search != null)
            {
                ...
                if (search.PrixMin.HasValue)
                {
                    // J'ajoute la condition si PrixMin est non null
                    listedesIarticlesDAO = listedesIarticlesDAO.Where(c => c.Price >= search.PrixMin);
                }
            ...
            var listedesIarticles = listedesIarticlesDAO
                                    ...
                                    .ProjectTo<Article>(mapper.ConfigurationProvider);
